...
namespace SwarmRobotControlAndCommunication
{
    ...
    public class TM4C123ControlBoard : usbGenericHidCommunication, ControlBoardInterface
	{
        ...
        private const byte RECEIVE_DATA_FROM_ROBOT_WITH_COMMAND = 0x11;
        private const byte RECEIVE_DATA_NO_COMMAND = 0x12;
        ...
        public void receiveBytesFromRobot(UInt32 numberOfReceivedBytes, ref byte[] data, UInt32 waitTime)
        {
            ...
            try
            {
                ...
                outputBuffer[0] = 0;
                outputBuffer[1] = RECEIVE_DATA_NO_COMMAND;
                // Do not use this byte
                outputBuffer[2] = 0;
                outputBuffer[3] = (byte)((numberOfReceivedBytes >> 24) & 0x0FF);
                outputBuffer[4] = (byte)((numberOfReceivedBytes >> 16) & 0x0FF);
                outputBuffer[5] = (byte)((numberOfReceivedBytes >> 8) & 0x0FF);
